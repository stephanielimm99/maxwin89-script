  ...
  wrap.innerHTML = `
    <div class="maxwin-box">
      <div class="left-panel">
        ...
        <select id="altLink">
          <option value="https://mw.akses-masuk.com">mw.akses-masuk.com</option>
          <option value="https://mw1.akses-masuk.com">mw1.akses-masuk.com</option>
          <option value="https://mw2.akses-masuk.com">mw2.akses-masuk.com</option>
        </select>
